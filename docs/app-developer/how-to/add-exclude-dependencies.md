...
- Completed the [Your first Maven build in 5 minutes](../getting-started/first-build.md), or equivalent familiarity with project coordinates and the `<dependencies>` section
...
- [Your first Maven build in 5 minutes](../getting-started/first-build.md).
